...
func TestHappyAddAnnotation(t *testing.T) {
	...
	ann := annotations.Annotation{Predicate: "http://www.ft.com/ontology/annotation/mentions", ConceptId: "http://www.ft.com/thing/100e3cc0-aecc-4458-8ebd-6b1fbc7345ed", ApiUrl: "", Type: "", PrefLabel: "", IsFTAuthor: false}
...
func TestHappyAddExistingAnnotation(t *testing.T) {
	...
	ann := annotations.Annotation{Predicate: "http://www.ft.com/ontology/annotation/mentions", ConceptId: "http://www.ft.com/thing/0a619d71-9af5-3755-90dd-f789b686c67a", ApiUrl: "", Type: "", PrefLabel: "", IsFTAuthor: false}
	b, _ := json.Marshal(ann)
...
func TestHappyAddAnnotationWithExistingConceptIdDifferentPredicate(t *testing.T) {
	...
	ann := annotations.Annotation{Predicate: "http://www.ft.com/ontology/annotation/mentions", ConceptId: "http://www.ft.com/thing/838b3fbe-efbc-3cfe-b5c0-d38c046492a4", ApiUrl: "", Type: "", PrefLabel: "", IsFTAuthor: false}
	b, _ := json.Marshal(ann)
...
func TestUnHappyAddAnnotationInvalidConceptIdPrefix(t *testing.T) {
	...
	ann := annotations.Annotation{Predicate: "http://www.ft.com/ontology/annotation/about", ConceptId: "http://www.ft.com/thing//838b3fbe-efbc-3cfe-b5c0-d38c046492a4", ApiUrl: "", Type: "", PrefLabel: "", IsFTAuthor: false}
	b, _ := json.Marshal(ann)
...
func TestUnHappyAddAnnotationEmptyConceptId(t *testing.T) {
	...
	ann := annotations.Annotation{Predicate: "http://www.ft.com/ontology/annotation/about", ConceptId: "", ApiUrl: "", Type: "", PrefLabel: "", IsFTAuthor: false}
	b, _ := json.Marshal(ann)
...
func TestUnHappyAddAnnotationInvalidUuid(t *testing.T) {
	...
	ann := annotations.Annotation{Predicate: "http://www.ft.com/ontology/annotation/about", ConceptId: "http://www.ft.com/thing//838b3fbe", ApiUrl: "", Type: "", PrefLabel: "", IsFTAuthor: false}
	b, _ := json.Marshal(ann)
...
func TestUnHappyAddAnnotationInvalidPredicate(t *testing.T) {
	...
	ann := annotations.Annotation{Predicate:"http://www.ft.com/ontology/annotation/foobar", ConceptId:"0a619d71-9af5-3755-90dd-f789b686c67a", ApiUrl:"", Type:"", PrefLabel:"", IsFTAuthor:false}
	b, _ := json.Marshal(ann)
